...
import { MatchCreationModal as SharedMatchCreationModal } from './MatchCreationModal';
...
function LobbyWorkspace({
  ...
  return (
    <Stack spacing={{ base: 6, md: 8 }} py={{ base: 6, md: 10 }}>
      ...
      <SharedMatchCreationModal isOpen={isCreateOpen} onClose={onCreateClose} onCreate={handleCreate} loading={lobby.loading} />
